package de.rdoe.weeklydjshows.resolver.newpipe.potoken
...
import de.rdoe.weeklydjshows.resolver.newpipe.NewPipeDownloader
...
class PoTokenWebView private constructor(
    ...
    private fun makeBotguardServiceRequest(
        ...
        disposables.add(
            Single.fromCallable {
                return@fromCallable NewPipeDownloader.post(
                    url,
                    mapOf(
    ...
    companion object : PoTokenGenerator.Factory {
        // Token material must never end up in normal application logs.
